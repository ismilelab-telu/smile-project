...
const liquidButtonClassName =
  "inline-flex items-center justify-center gap-2 rounded-xl border border-neutral-200 px-5 py-3 text-sm font-semibold text-neutral-950 backdrop-blur-xl shadow-[inset_0_1px_0_oklch(100%_0_0),0_12px_32px_oklch(0%_0_0_/_0.08)] hover:text-neutral-50 [--liquid-button-background-color:oklch(100%_0_0)] [--liquid-button-color:var(--color-neutral-950)]";
...
export function FuzzyTextPage({ path = "/" }: FuzzyTextPageProps) {
  ...
  return (
    <main className="relative flex min-h-screen overflow-hidden bg-white text-neutral-950">
