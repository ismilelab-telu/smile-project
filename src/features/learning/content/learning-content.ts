...
function multipleChoiceLesson(input: MultipleChoiceLessonInput): Lesson {
  return {
    ...
    exercise: {
      ...
      hints: getLearningExerciseHints(input.exerciseId, "id"),
      id: input.exerciseId,
...
const lesson06ProblemExercise = {
  ...
  hints: getLearningExerciseHints("exercise-0-6-formulate-problem", "id"),
...
const lesson12DecisionExercise: MultipleChoiceExercise = {
  ...
  hints: getLearningExerciseHints("exercise-1-2-data-collecting", "id"),
...
const lesson12OpenSourceExercise: OpenDatasetSourceExercise = {
  hints: getLearningExerciseHints("exercise-1-2-open-source-data-search", "id"),
